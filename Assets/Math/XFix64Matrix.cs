...
public partial struct XFix64Vector2x2
{
    /// <summary>
    /// Computes a XFix64Vector2x2 matrix representing a counter-clockwise rotation by an angle in radians.
    /// </summary>
    /// <remarks>
    ...
    public static XFix64Vector2x2 Rotate(float angle)
    {
        float s, c;
        sincos(angle, out s, out c);
        return new XFix64Vector2x2(c, -s,
                        s, c);
    }

    /// <summary>Returns a XFix64Vector2x2 matrix representing a uniform scaling of both axes by s.</summary>
    /// <param name="s">The scaling factor.</param>
    /// <returns>The XFix64Vector2x2 matrix representing uniform scale by s.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XFix64Vector2x2 Scale(float s)
    {
        return new XFix64Vector2x2(s, 0.0f,
                        0.0f, s);
    }

    /// <summary>Returns a XFix64Vector2x2 matrix representing a non-uniform axis scaling by x and y.</summary>
    /// <param name="x">The x-axis scaling factor.</param>
    /// <param name="y">The y-axis scaling factor.</param>
    /// <returns>The XFix64Vector2x2 matrix representing a non-uniform scale.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XFix64Vector2x2 Scale(float x, float y)
    {
        return new XFix64Vector2x2(x, 0.0f,
                        0.0f, y);
    }

    /// <summary>Returns a XFix64Vector2x2 matrix representing a non-uniform axis scaling by the components of the XFix64Vector2 vector v.</summary>
    /// <param name="v">The XFix64Vector2 containing the x and y axis scaling factors.</param>
    /// <returns>The XFix64Vector2x2 matrix representing a non-uniform scale.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XFix64Vector2x2 Scale(XFix64Vector2 v)
    {
